<template>
    <div id="poster">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" label-position="left"
            ...
            <!--邮箱-->
            <el-form-item type="text" label="" prop="email">
                <el-input v-model="ruleForm.email" autocomplete="off" placeholder="请输入邮箱"
                    prefix-icon="el-icon-notebook-1"><!--输入框的图标-->
                </el-input>
            </el-form-item>
            ...
            <el-form-item>
                ...
                <el-button type="primary" @click="toLogin()">登录</el-button><!---跳转到登录页面-->
            </el-form-item>
        </el-form>
    </div>
</template>
